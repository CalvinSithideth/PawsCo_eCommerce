	...
	<div style="text-align: center; margin-left: 10%">
		<div class="row row-cols-1 row-cols-md-3"
			...
			<c:forEach var="product" items="${requestScope.products}">
				...
				<c:if
					test="${param.filter == null && param.min == null && param.max == null && param.search == null || param.search != null && fn:containsIgnoreCase(product.name, param.search) || product.category == param.filter || product.price >= min && product.price <= max}">
					...
					<div class="col mb-4 ${product.category}">
						<div class="card h-100 item-card">
							...
							<div class="view overlay">
								<img class="card-img"
									src="resources/images/${product.imageFileName}"
									alt="Card image cap"
							...
							<div class="card-body">
								<div class="collapse-content">
									...
									<a
										...
										href="#collapseContent${product.productID}"
										aria-expanded="false"
										aria-controls="collapseContent${product.productID}">Read
										More</a>
								</div>
							</div>
						</div>
